      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Text("There's a lot happening arround you!", style: TextStyle(
              fontSize: 30, color: Colors.teal
            ),),
          ),
          Container(
            padding: EdgeInsets.fromLTRB(20, 20, 20, 20),
            child: Text("We must stay focused. We'll help you attend relevant occasions meant for you. :)", style: TextStyle(
              fontSize: 20,
            ),),
          ),
          ...
          Row(
            ...
            children: [
              ElevatedButton(onPressed: toLogin,
              child: Text('LogIn'),
              style: ButtonStyle(
           ...
           SizedBox(width: 50.0,),
            ...
            ElevatedButton(onPressed: toSignup, 
            child: Text('SignUp'),
            style: ButtonStyle(
              minimumSize: MaterialStateProperty.all(
                Size(MediaQuery.of(context).size.width / 3, 50),
